...
class Alzheimer_s(APIView):
    # parser_classes = [MultiPartParser]
    # loaded_model = joblib.load('./models/alzheimer/colab/colab_best_model_TransferLearning_LogisticRegression_Alzheimer.pkl')
    # classes = ['MildDemented', 'ModerateDemented', 'NonDemented', 'VeryMildDemented']
    # best_model_ConvNeXt = load_model('./models/alzheimer/colab/ConvNeXt_model-027.keras')
